...
try:
    from navarp.utils import navplt, ktransf, isocut, kinterp, denoise
except ImportError:
...
class IsoScan:
    ...
    def export_as_hdf5(
        ...
        if self.denoised:
            data = denoise.denoise_data(data)
...
class IsoK:
    ...
    def export_as_nxs(
        ...
        if self.denoised:
            data = denoise.denoise_data(self.data.transpose())
        else:
    ...
    def export_as_itx(
        ...
        if self.denoised:
            data = denoise.denoise_data(self.data)
        else:
            data = self.data
